...
public class Solution {
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            this.name = inputStreamReader.readLine();
            System.out.println(this.name);
            int assets = Integer.parseInt(inputStreamReader.readLine());
            System.out.println(assets);
            if (assets > 0) {
                for (int i = 0; i < assets; i++) {
                    this.assets.add(new Asset(inputStreamReader.readLine(), Double.parseDouble(inputStreamReader.readLine())));
                    System.out.println(this.assets.get(i).getName());
                }
            }
        }
    }
