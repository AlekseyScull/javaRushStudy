...
// тут был вес 100
                ...
                //правильное решение, не приходится сравнивать аргументы всеми способами
                return (result = name1.compareTo(name2)) != 0 ? result : (result = (int)(date2 - date1)) != 0 ? result : (int)(change2 - change1) * 1000;
            }
        });
    }
